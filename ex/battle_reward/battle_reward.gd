...
const CARD_REWARDS = preload("res://player/card_rewards.tscn")
const REWARD_BUTTON = preload("res://player/reward_button.tscn")
const GOLD_ICON = preload("res://assets/Images/Items/gem4x.png")
const GOLD_TEXT := "%s GOLD"
const CARD_ICON := preload("res://assets/Images/Card.png")
