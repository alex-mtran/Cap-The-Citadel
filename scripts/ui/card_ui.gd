...
var disabled := false # When using one card, disable using other cards

func _ready() -> void:
	Events.card_aim_begin.connect(_on_card_drag_or_aiming_started)
	Events.card_drag_begin.connect(_on_card_drag_or_aiming_started)
	Events.card_drag_end.connect(_on_card_drag_or_aim_ended)
	Events.card_aim_end.connect(_on_card_drag_or_aim_ended)
